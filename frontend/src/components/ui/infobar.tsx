  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          'sticky top-0 z-30 hidden h-[calc(100dvh-3.5rem)] w-(--infobar-width) shrink-0 overflow-hidden border-t transition-[width,opacity] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] md:flex',
          side === 'right' ? 'rounded-tl-xl border-l' : 'rounded-tr-xl border-r',
